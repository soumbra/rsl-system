...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ResponseWrapper<Object>> handleGenericException(
    ...
    ResponseWrapper<Object> response =
        ResponseWrapper.error("ERROR", "Erro interno do servidor", ex.getMessage());
  ...
  public ResponseEntity<ResponseWrapper<Object>> handleNotFound(
    ...
    ResponseWrapper<Object> response =
        ResponseWrapper.error("NOT_FOUND", "Recurso não encontrado", ex.getResourcePath());
  ...
  public ResponseEntity<ResponseWrapper<Object>> handleRuntimeException(
    ...
    ResponseWrapper<Object> response =
        ResponseWrapper.error("ERROR", "Erro de execução", ex.getMessage());
